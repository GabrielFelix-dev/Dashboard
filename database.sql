...
CREATE TABLE `anotacoes` (
  ...
  CONSTRAINT `anotacoes_ibfk_1` FOREIGN KEY (`id_usuario_fk`) REFERENCES `usuario` (`id_usuario`)
...
CREATE TABLE `produto` (
  ...
  KEY `id_usuario_fk` (`id_usuario_fk`),
  CONSTRAINT `produto_ibfk_1` FOREIGN KEY (`id_usuario_fk`) REFERENCES `usuario` (`id_usuario`)
...
-- Dump completed on 2026-06-24 23:47:30
